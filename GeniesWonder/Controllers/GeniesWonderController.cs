using GeniesWonder.Helpers;
using Microsoft.AspNetCore.Mvc;
using Models.GeniesWonder;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;
using Services.Common;
using Services.GeniesWonder;
using Services.Jwt;
using System;
using System.Data;
using System.IO;
...
namespace GeniesWonder.Controllers
{

    [ApiController]
    [Route("api/game")]
    public class GeniesWonderController : ControllerBase
    {//test
        private readonly ITokenManager _tokenManager;
        private readonly IJwtHandler _jwtHandler;
        private readonly IGeniesWonderService _popballservice;
        private readonly ErrorLog _Elog;
        private readonly HttpHelper _httpHelper;
        private readonly Config _config;
        //private readonly IHostingEnvironment _env;ajksd
        public GeniesWonderController(ITokenManager tokenManager, IJwtHandler jwtHandler, /*IHostingEnvironment env,*/ IGeniesWonderService popballservice, ErrorLog Elog, Config config, HttpHelper httpHelper)
        {

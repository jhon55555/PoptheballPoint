...
namespace Slot2.Controllers
{

    [ApiController]
    [Route("api/game")]
    public class Slot2Controller : ControllerBase
    {//test
        private readonly ITokenManager _tokenManager;
        private readonly IJwtHandler _jwtHandler;
        private readonly ISlot2Service _popballservice;
        private readonly ErrorLog _Elog;
        private readonly HttpHelper _httpHelper;
        private readonly Config _config;
        //private readonly IHostingEnvironment _env;ajksd
        public Slot2Controller(ITokenManager tokenManager, IJwtHandler jwtHandler, /*IHostingEnvironment env,*/ ISlot2Service popballservice, ErrorLog Elog, Config config, HttpHelper httpHelper)
        {

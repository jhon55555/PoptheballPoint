...
namespace Poptheball
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    builder => builder.WithOrigins("https://popball.worldserviceprovider.com/").AllowAnyHeader().AllowAnyMethod().AllowCredentials());
            //});
            services.AddSingleton<AuthKeyfilterlogin>();
            services.AddSingleton<AuthLocal>();
            services.AddSingleton<AuthKeyfilter>();
            services.AddSingleton<AuthCasino>();
            ...
            services.AddSingleton<IPoptheballService, PoptheballService>();

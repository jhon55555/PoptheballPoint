...
namespace Teen.Controllers
{
    ...
    {//test
        ...
        private readonly ITeenService _popballservice;
        private readonly ErrorLog _Elog;
        private readonly HttpHelper _httpHelper;
        private readonly Config _config;
        //private readonly IHostingEnvironment _env;ajksd
        public TeenController(ITokenManager tokenManager, IJwtHandler jwtHandler, /*IHostingEnvironment env,*/ ITeenService popballservice, ErrorLog Elog, Config config, HttpHelper httpHelper)
        {

...
{
    public class LudolandsService : ILudolandsService
    {
        #region Fields
        ...
        #endregion
        public LudolandsService(ISqlClient sqlClient, Config config, ErrorLogService errorLogService)
        {
            _config = config;
        ...
        public async Task<DataSet> validuser(String uid, String gtype)
        {
            try
            {
                ...
                parameters.Add(new SqlParameter() { ParameterName = "CasinoType", Value = gtype });
        ...
        public async Task<DataSet> getcheckbalance(String uid)
        {
            try
            {
                ...
                var parameters = new List<SqlParameter>();
                parameters.Add(new SqlParameter() { ParameterName = "Userid", Value = uid });
                parameters.Add(new SqlParameter() { ParameterName = "CasinoType", Value = "ludo-lands" });
        ...
        public async Task<DataSet> debit(String uid, String token, String gameId, String roundId, String tid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            try
            {
                ...
                ds = await _sqlClient.Executeasync("ludolands_placebet", _config.Conn_CasinoMaster, parameters);
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> credit(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            ...
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("ludolands_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("credit+ludolands_placebet+credit", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> Rollback(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            ...
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("ludolands_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("Rollback+ludolands_placebet+rollback", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {

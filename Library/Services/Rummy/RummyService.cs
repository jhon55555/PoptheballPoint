...
{
    public class RummyService : IRummyService
    {
        #region Fields
        ...
        #endregion
        public RummyService(ISqlClient sqlClient, Config config, ErrorLogService errorLogService)
        {
            _config = config;
        ...
        public async Task<DataSet> validuser(String uid)
        {
            try
            {
                ...
                parameters.Add(new SqlParameter() { ParameterName = "CasinoType", Value = "rummy" });
        ...
        public async Task<DataSet> debit(String uid, String token, String gameId, String roundId, String tid, String rate, String amt, String wl, Double gen, String pdt, String udt,Double remamt)
        {
            try
            {
                DataSet ds = new DataSet();
                ...
                parameters.Add(new SqlParameter() { ParameterName = "remainingamt", Value = remamt });
                parameters.Add(new SqlParameter() { ParameterName = "statement", Value = "debit" });
                ds = await _sqlClient.Executeasync("rummy_placebet", _config.Conn_CasinoMaster, parameters);
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> credit(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt, Double remamt)
        {
            try
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("rummy_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("credit+rummy_placebet+credit", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> Rollback(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt, Double remamt)
        {
            try
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("rummy_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("Rollback+rummy_placebet+rollback", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {

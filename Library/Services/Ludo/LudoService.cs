...
namespace Services.Ludo
{
    public class LudoService : ILudoService
    {
        ...
        #endregion
        public LudoService(ISqlClient sqlClient, Config config, ErrorLogService errorLogService)
        {
            _config = config;
        ...
        public async Task<DataSet> BalanceCallback(String guid)
        {
            try
            {
                ...
                ds = await _sqlClient.Executeasync("ludoclub_login", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("BalanceCallback+TpCasinoUserData+userbalance", guid + "Res:" + JsonConvert.SerializeObject(ds));
        ...
        public async Task<DataSet> validuser(String uid)
        {
            try
            {
                ...
                parameters.Add(new SqlParameter() { ParameterName = "CasinoType", Value = "ludo-club" });
        ...
        public async Task<DataSet> debit(String uid, String token, String gameId, String roundId, String tid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            try
            {
                ...
                ds = await _sqlClient.Executeasync("ludoclub_placebet", _config.Conn_CasinoMaster, parameters);
                return ds;
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> credit(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            ...
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("ludoclub_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("credit+ludoclub_placebet+credit", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;  
            }
            catch (Exception ex)
            {
        ...
        public async Task<DataSet> Rollback(String uid, String token, String gameId, String roundId, String tid, String renid, String rate, String amt, String wl, Double gen, String pdt, String udt)
        {
            ...
            {//@guid,@token,@gameid,@roundid,@txnid,@referenceid,@rate,@amount,@winloss,@general,@placedate,@updatedate
                ...
                ds = await _sqlClient.Executeasync("ludoclub_placebet", _config.Conn_CasinoMaster, parameters);
                _errorLogService.WriteLog("Rollback+ludoclub_placebet+rollback", renid + "Res:" + JsonConvert.SerializeObject(ds));
                return ds;
            }
            catch (Exception ex)
            {

...
namespace Services.Poptheball
{
    public class PoptheballService : IPoptheballService
    {
        #region Fields
        ...
        #endregion
        public PoptheballService(ISqlClient sqlClient, Config config, ErrorLogService errorLogService)
        {
            _config = config;

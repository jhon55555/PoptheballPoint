...
namespace Poker.Controllers
{
    ...
    {//test
        ...
        private readonly IPokerService _popballservice;
        private readonly ErrorLog _Elog;
        private readonly HttpHelper _httpHelper;
        private readonly Config _config;
        //private readonly IHostingEnvironment _env;ajksd
        public PokerController(ITokenManager tokenManager, IJwtHandler jwtHandler, /*IHostingEnvironment env,*/ IPokerService popballservice, ErrorLog Elog, Config config, HttpHelper httpHelper)
        {

...
namespace Rummy.Controllers
{
    ...
    public class RummyController : ControllerBase
    {//test
        private readonly ITokenManager _tokenManager;
        private readonly IJwtHandler _jwtHandler;
        private readonly IRummyService _popballservice;
        private readonly ErrorLog _Elog;
        private readonly HttpHelper _httpHelper;
        private readonly Config _config;
        //private readonly IHostingEnvironment _env;ajksd
        public RummyController(ITokenManager tokenManager, IJwtHandler jwtHandler, /*IHostingEnvironment env,*/ IRummyService popballservice, ErrorLog Elog, Config config, HttpHelper httpHelper)
        {
        ...
        public async Task<IActionResult> Testd()
        {
            try
            {
                var result = _httpHelper.Get("http://3.249.22.134:8001/api/game/test", "");
                return Ok(new { Body = result });
            }
            catch (Exception ex)
            {
                _Elog.WriteLog("Testd", ex.Message.ToString());
        ...
        public async Task<IActionResult> Test()
        {
            ...
            try
            {
                return Ok(new { Body = "Success" });
            }
            catch (Exception ex)
            {
                _Elog.WriteLog("Test", ex.Message.ToString());
                return Return400(ex.Message);
            }
        }
        //[EnableCors("AnotherPolicy")]
        ...
        public async Task<IActionResult> BetUrl([FromBody] BalanceCallback balanceCallback)
        {
            ...
            try
            {
                ...
                {
                    var TblData = await _popballservice.debit(obj.PlayerId, obj.Session, obj.GameId, obj.RoundId, obj.Id, obj.Odd, obj.Stake, obj.Win, Convert.ToDouble(TblData1.Tables[0].Rows[0]["general"]) - Convert.ToDouble(TblData1.Tables[0].Rows[0]["exposer"]), obj.Created, obj.Updated, obj.Remaining);
        ...
        public async Task<IActionResult> BetResult([FromBody] BalanceCallback balanceCallback)
        {
            ...
            try
            {
                ...
                //var obj = JsonConvert.DeserializeObject<BetResultres>(balanceCallback.Body);
                ...
                var TblData = await _popballservice.credit(obj.PlayerId, obj.Session, obj.GameId, obj.RoundId, obj.Id, obj.Refference, obj.Odd, obj.Stake, obj.Win, 0, obj.Created, obj.Updated, obj.Remaining);
        ...
        public async Task<IActionResult> Rollback([FromBody] BalanceCallback balanceCallback)
        {
            ...
            try
            {
                ...
                //if (TblData1 != null && TblData1.Tables.Count > 0 && TblData1.Tables[0].Rows.Count > 0 && TblData1.Tables[0].Rows[0]["id"].ToString() == "1")
                //{
                var TblData = await _popballservice.Rollback(obj.PlayerId, obj.Session, obj.GameId, obj.RoundId, obj.Id, obj.Refference, obj.Odd, obj.Stake, obj.Win, 0, obj.Created, obj.Updated, obj.Remaining);
